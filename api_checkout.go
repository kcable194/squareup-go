...
/*
CheckoutApiService RetrieveLocationSettings
...
func (a *CheckoutApiService) RetrieveLocationSettings(ctx context.Context, locationId string) (RetrieveLocationSettingsResponse, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue RetrieveLocationSettingsResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/online-checkout/location-settings/{location_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"location_id"+"}", fmt.Sprintf("%v", locationId), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v RetrieveLocationSettingsResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
CheckoutApiService RetrieveMerchantSettings
Retrieves the merchant-level settings for a Square-hosted checkout page.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return RetrieveMerchantSettingsResponse
*/
func (a *CheckoutApiService) RetrieveMerchantSettings(ctx context.Context) (RetrieveMerchantSettingsResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue RetrieveMerchantSettingsResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/online-checkout/merchant-settings"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v RetrieveMerchantSettingsResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
CheckoutApiService UpdateLocationSettings
...
*/
func (a *CheckoutApiService) UpdateLocationSettings(ctx context.Context, body UpdateLocationSettingsRequest, locationId string) (UpdateLocationSettingsResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue UpdateLocationSettingsResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v UpdateLocationSettingsResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
CheckoutApiService UpdateMerchantSettings
...
*/
func (a *CheckoutApiService) UpdateMerchantSettings(ctx context.Context, body UpdateMerchantSettingsRequest) (UpdateMerchantSettingsResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue UpdateMerchantSettingsResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v UpdateMerchantSettingsResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
