...
*/
func (a *SitesApiService) ListSites(ctx context.Context) (ListSitesResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ListSitesResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/sites"
