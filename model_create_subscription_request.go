...
// Defines input parameters in a request to the  [CreateSubscription](https://developer.squareup.com/reference/square_2024-01-18/subscriptions-api/create-subscription) endpoint.
type CreateSubscriptionRequest struct {
	...
	// The ID of the [customer](https://developer.squareup.com/reference/square_2024-01-18/objects/Customer) subscribing to the subscription plan variation.
	...
	// The ID of the [subscriber's](https://developer.squareup.com/reference/square_2024-01-18/objects/Customer) [card](https://developer.squareup.com/reference/square_2024-01-18/objects/Card) to charge. If it is not specified, the subscriber receives an invoice via email with a link to pay for their subscription.
