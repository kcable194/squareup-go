...
// Represents an [UpdateMerchantCustomAttributeDefinition](https://developer.squareup.com/reference/square_2024-01-18/merchant-custom-attributes-api/update-merchant-custom-attribute-definition) request.
