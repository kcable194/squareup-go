...
// Represents the metadata for a `POINTS_MULTIPLIER` type of [loyalty promotion incentive](https://developer.squareup.com/reference/square_2024-01-18/objects/LoyaltyPromotionIncentive).
