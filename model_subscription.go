...
type Subscription struct {
	...
	// The ID of the subscribed-to [subscription plan variation](https://developer.squareup.com/reference/square_2024-01-18/objects/CatalogSubscriptionPlanVariation).
	PlanVariationId string `json:"plan_variation_id,omitempty"`
	// The ID of the subscribing [customer](https://developer.squareup.com/reference/square_2024-01-18/objects/Customer) profile.
	...
	// The IDs of the [invoices](https://developer.squareup.com/reference/square_2024-01-18/objects/Invoice) created for the subscription, listed in order when the invoices were created (newest invoices appear first).
	...
	// The ID of the [subscriber's](https://developer.squareup.com/reference/square_2024-01-18/objects/Customer) [card](https://developer.squareup.com/reference/square_2024-01-18/objects/Card) used to charge for the subscription.
