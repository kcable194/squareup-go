...
// Represents an [UpdateBookingCustomAttributeDefinition](https://developer.squareup.com/reference/square_2024-01-18/booking-custom-attributes-api/update-booking-custom-attribute-definition) request.
