 ...
 * @param optional nil or *DevicesApiListDeviceCodesOpts - Optional Parameters:
     ...
     * @param "ProductType" (optional.String) -  If specified, only returns DeviceCodes targeting the specified product type. Returns DeviceCodes of all product types if empty.
     * @param "Status" (optional.String) -  If specified, returns DeviceCodes with the specified statuses. Returns DeviceCodes of status &#x60;PAIRED&#x60; and &#x60;UNPAIRED&#x60; if empty.
