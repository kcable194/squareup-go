...
// Represents a [CreateLocationCustomAttributeDefinition](https://developer.squareup.com/reference/square_2024-01-18/location-custom-attributes-api/create-location-custom-attribute-definition) request.
