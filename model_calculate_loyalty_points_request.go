...
// Represents a [CalculateLoyaltyPoints](https://developer.squareup.com/reference/square_2024-01-18/loyalty-api/calculate-loyalty-points) request.
type CalculateLoyaltyPointsRequest struct {
	// The [order](https://developer.squareup.com/reference/square_2024-01-18/objects/Order) ID for which to calculate the points. Specify this field if your application uses the Orders API to process orders. Otherwise, specify the `transaction_amount_money`.
