...
type ListGiftCardsRequest struct {
	// If a [type](https://developer.squareup.com/reference/square_2024-01-18/enums/GiftCardType) is provided, the endpoint returns gift cards of the specified type. Otherwise, the endpoint returns gift cards of all types.
	Type_ string `json:"type,omitempty"`
	// If a [state](https://developer.squareup.com/reference/square_2024-01-18/enums/GiftCardStatus) is provided, the endpoint returns the gift cards in the specified state. Otherwise, the endpoint returns the gift cards of all states.
