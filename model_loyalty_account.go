...
// Describes a loyalty account in a [loyalty program](https://developer.squareup.com/reference/square_2024-01-18/objects/LoyaltyProgram). For more information, see [Create and Retrieve Loyalty Accounts](https://developer.squareup.com/docs/loyalty-api/loyalty-accounts).
type LoyaltyAccount struct {
	// The Square-assigned ID of the loyalty account.
	Id string `json:"id,omitempty"`
	// The Square-assigned ID of the [loyalty program](https://developer.squareup.com/reference/square_2024-01-18/objects/LoyaltyProgram) to which the account belongs.
	...
	// The Square-assigned ID of the [customer](https://developer.squareup.com/reference/square_2024-01-18/objects/Customer) that is associated with the account.
