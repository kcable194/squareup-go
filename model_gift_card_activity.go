...
// Represents an action performed on a [gift card](https://developer.squareup.com/reference/square_2024-01-18/objects/GiftCard) that affects its state or balance.  A gift card activity contains information about a specific activity type. For example, a `REDEEM` activity includes a `redeem_activity_details` field that contains information about the redemption.
type GiftCardActivity struct {
	// The Square-assigned ID of the gift card activity.
	Id string `json:"id,omitempty"`
	// The type of gift card activity.
	Type_ string `json:"type"`
	// The ID of the [business location](https://developer.squareup.com/reference/square_2024-01-18/objects/Location) where the activity occurred.
