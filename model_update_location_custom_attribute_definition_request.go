...
// Represents an [UpdateLocationCustomAttributeDefinition](https://developer.squareup.com/reference/square_2024-01-18/location-custom-attributes-api/update-location-custom-attribute-definition) request.
