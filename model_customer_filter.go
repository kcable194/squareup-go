...
// Represents the filtering criteria in a [search query](https://developer.squareup.com/reference/square_2024-01-18/objects/CustomerQuery) that defines how to filter customer profiles returned in [SearchCustomers](https://developer.squareup.com/reference/square_2024-01-18/customers-api/search-customers) results.
