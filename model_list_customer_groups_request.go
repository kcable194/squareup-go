...
// Defines the query parameters that can be included in a request to the [ListCustomerGroups](https://developer.squareup.com/reference/square_2024-01-18/customer-groups-api/list-customer-groups) endpoint.
