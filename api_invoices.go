 ...
 * @param invoiceId The ID of the [invoice](https://developer.squareup.com/reference/square_2024-01-18/objects/Invoice) to cancel.
...
/*
InvoicesApiService DeleteInvoiceAttachment
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param invoiceId The ID of the [invoice](https://developer.squareup.com/reference/square_2024-01-18/objects/Invoice) to delete the attachment from.
 * @param attachmentId The ID of the [attachment](https://developer.squareup.com/reference/square_2024-01-18/objects/InvoiceAttachment) to delete.
...
func (a *InvoicesApiService) DeleteInvoiceAttachment(ctx context.Context, invoiceId string, attachmentId string) (DeleteInvoiceAttachmentResponse, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue DeleteInvoiceAttachmentResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/invoices/{invoice_id}/attachments/{attachment_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"invoice_id"+"}", fmt.Sprintf("%v", invoiceId), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v DeleteInvoiceAttachmentResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
