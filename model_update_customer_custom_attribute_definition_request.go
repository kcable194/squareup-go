...
// Represents an [UpdateCustomerCustomAttributeDefinition](https://developer.squareup.com/reference/square_2024-01-18/customer-custom-attributes-api/update-customer-custom-attribute-definition) request.
