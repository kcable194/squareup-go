...
// Represents an [UpsertMerchantCustomAttribute](https://developer.squareup.com/reference/square_2024-01-18/merchant-custom-attributes-api/upsert-merchant-custom-attribute) request.
