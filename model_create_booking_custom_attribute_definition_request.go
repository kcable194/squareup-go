...
// Represents a [CreateBookingCustomAttributeDefinition](https://developer.squareup.com/reference/square_2024-01-18/booking-custom-attributes-api/create-booking-custom-attribute-definition) request.
