...
// Describes a request to list refunds using [ListPaymentRefunds](https://developer.squareup.com/reference/square_2024-01-18/refunds-api/list-payment-refunds).  The maximum results per page is 100.
type ListPaymentRefundsRequest struct {
	...
	// If provided, only refunds with the given status are returned. For a list of refund status values, see [PaymentRefund](https://developer.squareup.com/reference/square_2024-01-18/objects/PaymentRefund).  Default: If omitted, refunds are returned regardless of their status.
