...
type Tender struct {
	...
	// The ID of the [Payment](https://developer.squareup.com/reference/square_2024-01-18/objects/Payment) that corresponds to this tender. This value is only present for payments created with the v2 Payments API.
