 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param orderId The ID of the target [order](https://developer.squareup.com/reference/square_2024-01-18/objects/Order).
 ...
 * @param optional nil or *OrderCustomAttributesApiListOrderCustomAttributeDefinitionsOpts - Optional Parameters:
     * @param "VisibilityFilter" (optional.String) -  Requests that all of the custom attributes be returned, or only those that are read-only or read-write.
