 ...
 * @param accountId The ID of the target [loyalty account](https://developer.squareup.com/reference/square_2024-01-18/objects/LoyaltyAccount).
...
See the corresponding object definition for field details.
 * @param programId The ID of the [loyalty program](https://developer.squareup.com/reference/square_2024-01-18/objects/LoyaltyProgram), which defines the rules for accruing points.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param promotionId The ID of the [loyalty promotion](https://developer.squareup.com/reference/square_2024-01-18/objects/LoyaltyPromotion) to cancel. You can cancel a promotion that has an &#x60;ACTIVE&#x60; or &#x60;SCHEDULED&#x60; status.
 * @param programId The ID of the base [loyalty program](https://developer.squareup.com/reference/square_2024-01-18/objects/LoyaltyProgram).
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param rewardId The ID of the [loyalty reward](https://developer.squareup.com/reference/square_2024-01-18/objects/LoyaltyReward) to delete.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param programId The ID of the base [loyalty program](https://developer.squareup.com/reference/square_2024-01-18/objects/LoyaltyProgram). To get the program ID, call [RetrieveLoyaltyProgram](https://developer.squareup.com/reference/square_2024-01-18/loyalty-api/retrieve-loyalty-program) using the &#x60;main&#x60; keyword.
 * @param optional nil or *LoyaltyApiListLoyaltyPromotionsOpts - Optional Parameters:
     * @param "Status" (optional.String) -  The status to filter the results by. If a status is provided, only loyalty promotions with the specified status are returned. Otherwise, all loyalty promotions associated with the loyalty program are returned.
...
See the corresponding object definition for field details.
 * @param rewardId The ID of the [loyalty reward](https://developer.squareup.com/reference/square_2024-01-18/objects/LoyaltyReward) to redeem.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId The ID of the [loyalty account](https://developer.squareup.com/reference/square_2024-01-18/objects/LoyaltyAccount) to retrieve.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param promotionId The ID of the [loyalty promotion](https://developer.squareup.com/reference/square_2024-01-18/objects/LoyaltyPromotion) to retrieve.
 * @param programId The ID of the base [loyalty program](https://developer.squareup.com/reference/square_2024-01-18/objects/LoyaltyProgram). To get the program ID, call [RetrieveLoyaltyProgram](https://developer.squareup.com/reference/square_2024-01-18/loyalty-api/retrieve-loyalty-program) using the &#x60;main&#x60; keyword.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param rewardId The ID of the [loyalty reward](https://developer.squareup.com/reference/square_2024-01-18/objects/LoyaltyReward) to retrieve.
