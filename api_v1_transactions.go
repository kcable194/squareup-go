 ...
 * @param optional nil or *V1TransactionsApiV1ListOrdersOpts - Optional Parameters:
     * @param "Order" (optional.String) -  The order in which payments are listed in the response.
 ...
 * @param optional nil or *V1TransactionsApiV1ListSettlementsOpts - Optional Parameters:
     * @param "Order" (optional.String) -  The order in which settlements are listed in the response.
     * @param "BeginTime" (optional.String) -  The beginning of the requested reporting period, in ISO 8601 format. If this value is before January 1, 2013 (2013-01-01T00:00:00Z), this endpoint returns an error. Default value: The current time minus one year.
     * @param "EndTime" (optional.String) -  The end of the requested reporting period, in ISO 8601 format. If this value is more than one year greater than begin_time, this endpoint returns an error. Default value: The current time.
     * @param "Limit" (optional.Int32) -  The maximum number of settlements to return in a single response. This value cannot exceed 200.
     * @param "Status" (optional.String) -  Provide this parameter to retrieve only settlements with a particular status (SENT or FAILED).
     * @param "BatchToken" (optional.String) -  A pagination cursor to retrieve the next set of results for your original query to the endpoint.
@return []V1Settlement
*/
