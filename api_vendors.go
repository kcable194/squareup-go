 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param vendorId ID of the [Vendor](https://developer.squareup.com/reference/square_2024-01-18/objects/Vendor) to retrieve.
...
*/
func (a *VendorsApiService) UpdateVendor(ctx context.Context, body UpdateVendorRequest, vendorId string) (UpdateVendorResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
