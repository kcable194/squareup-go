...
/*
SubscriptionsApiService BulkSwapPlan
...
*/
func (a *SubscriptionsApiService) BulkSwapPlan(ctx context.Context, body BulkSwapPlanRequest) (BulkSwapPlanResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue BulkSwapPlanResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/subscriptions/bulk-swap-plan"
...
/*
SubscriptionsApiService ChangeBillingAnchorDate
...
*/
func (a *SubscriptionsApiService) ChangeBillingAnchorDate(ctx context.Context, body ChangeBillingAnchorDateRequest, subscriptionId string) (ChangeBillingAnchorDateResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ChangeBillingAnchorDateResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/subscriptions/{subscription_id}/billing-anchor"
	localVarPath = strings.Replace(localVarPath, "{"+"subscription_id"+"}", fmt.Sprintf("%v", subscriptionId), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ChangeBillingAnchorDateResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
